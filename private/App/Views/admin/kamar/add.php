      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <select class="form-control" required name="id_rumah_sakit" id="id_rumah_sakit">
            ...
            <option <?= $data_flasher ? ($data_flasher['id_rumah_sakit'] === $rs['id_rumah_sakit'] ? 'selected' : '') : '' ?> value="0"><?= $rs['nama_rumah_sakit'] ?></option>
            <?php endforeach; ?>
          </select>
        </div>
        <div class="form-group">
            ...
            <div class="row">
              <div class="col-md">
                <div class="form-group">
                  ...
                  <input type="number" value="<?= $data_flasher ? $data_flasher['ketersediaan_kamar'] : '' ?>" min="0" placeholder="Ketersediaan Kamar" required name="ketersediaan_kamar" id="ketersediaan_kamar" class="form-control">
                </div>
              </div>
              <div class="col-md">
                <div class="form-group">
                  <label for="kamar_tersedia">Kamar Yang Tersedia <span class="text-danger">*</span></label>
                  <input type="number" value="<?= $data_flasher ? $data_flasher['kamar_tersedia'] : '' ?>" min="0" placeholder="Kamar Yang Tersedia" required name="kamar_tersedia" id="kamar_tersedia" class="form-control">
                </div>
              </div>
            </div>
          </div>
