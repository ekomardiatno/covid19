<form action="<?= Web::url('admin.tempat-tidur.post') ?>" method="POST">
    ...
    <div class="card bg-secondary shadow mb-3">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" maxlength="100" value="<?= $data_flasher ? $data_flasher['nama_kotak'] : '' ?>" placeholder="Nama Tempat Tidur" required name="nama_tempat_tidur" id="nama_tempat_tidur" class="form-control">
        </div>
        <div class="row mb-3">
          <div class="col-12">
            <div class="row">
              <div class="col-md">
                <div class="form-group">
                  ...
                  <input type="number" value="<?= $data_flasher ? $data_flasher['total_tempat_tidur'] : 0 ?>" min="0" placeholder="Ketersediaan Tempat Tidur" required name="total_tempat_tidur" id="total_tempat_tidur" class="form-control">
                </div>
              </div>
              <div class="col-md">
                <div class="form-group">
                  <label for="tempat_tidur_terisi">Tempat Tidur Yang Terisi <span class="text-danger">*</span></label>
                  <input type="number" value="<?= $data_flasher ? $data_flasher['tempat_tidur_terisi'] : 0 ?>" min="0" placeholder="Tempat Tidur Yang Terisi" required name="tempat_tidur_terisi" id="tempat_tidur_terisi" class="form-control">
                </div>
              </div>
            </div>
          </div>
