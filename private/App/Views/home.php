            ...
            <div class="d-md-flex mx-md--3 <?= count($data['rumah_sakit']) === $i + 1 ? '' : 'border-bottom pb-5' ?>">
              <div class="flex-md-col mx-md-3 mb-3 mb-md-0 ml-md-0">
                ...
                <?php if ($r['latitude'] . ',' . $r['longitude'] !== '0,0') : ?>
                  <a class="badge bg-primary py-2 px-3" target="_blank" href="http://maps.google.com/?q=<?= $r['latitude'] . ',' . $r['longitude']; ?>"><i class="fas fa-location-arrow"></i> Lihat di Peta</a>
                <?php endif; ?>
                <a class="badge bg-warning text-dark py-2 px-3" href="<?= Web::url('tempat-tidur.' . md5($r['id_rumah_sakit'])) ?>"><i class="fas fa-procedures"></i> Tempat Tidur</a>
              </div>
