      ...
      <table class="table table-striped align-items-center table-flush datatables">
        <thead class="thead-light">
          <tr>
            ...
            <th class="text-center" width="50%" scope="col">Alamat</th>
            ...
            <tr>
              ...
              <td class="<?= $d['latitude'] . ',' . $d['longitude'] !== '0,0' ? '' : 'text-center' ?>">
                <?php if ($d['latitude'] . ',' . $d['longitude'] !== '0,0') : ?>
                  <a target="_blank" href="http://maps.google.com/?q=<?= $d['latitude'] . ',' . $d['longitude']; ?>"><i class="fas fa-location-arrow"></i> Lihat di Peta</a>
                <?php else : ?>
                  <span>-</span>
                <?php endif; ?>
              </td>
