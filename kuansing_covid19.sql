...
(3, 1, 'Dr. Agus Mandar, M.Si', 'Ka. Satgas Covid-19 Kuansing', '+628127583401', '2021-06-09 09:21:28', '2021-06-09 09:34:52'),
...
INSERT INTO `rumah_sakit` (`id_rumah_sakit`, `nama_rumah_sakit`, `alamat_rumah_sakit`, `telepon_rumah_sakit`, `tanggal_dibuat`, `tanggal_diedit`) VALUES
(1, 'RSUD TELUK KUANTAN', 'Komplek Perkantoran PEMDA KUANSING, Kelurahan, Sungai Jering, Kuantan Tengah, Kabupaten Kuantan Singingi, Riau 29562', 'a:2:{i:0;s:12:\"082219594614\";i:1;s:12:\"081144653321\";}', '2021-06-09 08:42:10', '2021-06-09 09:50:25');
...
(1, 'admin', 'Administrator', 'admin@email.com', '$2y$10$yilV5k67WnmfiRtLdek.Pe.SeNZuDwrR7VhDPPYFfKdVuJtY5W6vm', 'admin', '2021-06-09 14:44:04');
...
--
ALTER TABLE `kasus_harian`
  MODIFY `id_kasus_harian` int(11) NOT NULL AUTO_INCREMENT;
